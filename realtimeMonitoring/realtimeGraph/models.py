...
class User(models.Model):
    ...
    role = models.ForeignKey(Role, on_delete=models.CASCADE, default=USER_ROLE_ID)
    active = models.BooleanField(default=True)
...
class Location(models.Model):
    ...
    city = models.ForeignKey(City, on_delete=models.CASCADE, default=USER_ROLE_ID)
    state = models.ForeignKey(State, on_delete=models.CASCADE, default=USER_ROLE_ID)
    country = models.ForeignKey(Country, on_delete=models.CASCADE, default=USER_ROLE_ID)
    active = models.BooleanField(default=True)
...
class Data(models.Model):
    ...
    def str(self):
        return "{} {} {} {}".format(
            self.value, self.time, self.station, self.measurement
        )
